...
const ru: Translation = {
  ...
  settings: {
    ...
    demoDataButton: "Демо для скринов",
    demoDataConfirmTitle: "Заменить всё демо-данными?",
    demoDataConfirmDesc: "Удалит твои текущие вопросы и записи и заменит их на 8 готовых вопросов + 60 дней инженерных ответов. Создано чтобы показать чистые корреляции для скриншотов и превью в App Store. Только для разработчика.",
