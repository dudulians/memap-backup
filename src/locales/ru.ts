...
const ru: Translation = {
  ...
  settings: {
    ...
    demoUnlockedDesc: "Теперь в Settings → Data есть 4 кнопки генерации демо-данных. Тапни на v1.7.3 ещё 7 раз чтобы выключить.",
    demoLockedTitle: "Demo Mode OFF",
    demoLockedDesc: "Кнопки демо-генерации спрятаны. Тапни v1.7.3 7 раз чтобы включить снова.",
    demoModeOn: "DEMO",
