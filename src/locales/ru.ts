...
const ru: Translation = {
  ...
  gender: {
    ...
    subtitle: "Чтобы вопросы подбирались под тебя",
    male: "Мужской",
    female: "Женский",
    neutral: "Не уточнять",
  },
  ...
  onboarding: {
    ...
    welcome: {
      ...
      body1: "Плохие дни ты помнишь ярче, чем хорошие. MeMap копит факты — чтобы ты потом увидел(а), что на самом деле было.",
      body2: "",
      cta: "Поехали",
    },
    ...
    goal: {
      ...
      understand: {
        ...
        subtitle: "Завести ребёнка, поменять работу, переехать, расстаться — увидеть паттерн прежде чем решать",
      },
      doctor: {
    ...
    stackReveal: {
      ...
      customExamples: "«Позвонил(а) маме?» «Тренировал(а)ся?» «Плакал(а) сегодня?» «Сорвал(а)ся на ребёнка?» — добавь то, на чём ты сам(а) себя ловишь, после того как пройдёшь дальше.",
    },

    defaultStarters: {
      sleepTitle: "Сон",
      sleepQ: "Спал(а) ли я больше 7 часов?",
      stressTitle: "Стресс",
      stressQ: "Чувствовал(а) ли я стресс сегодня?",
      moveTitle: "Движение",
      moveQ: "Двигал(а) ли я тело сегодня?",
      connectionTitle: "Близкие",
      connectionQ: "Поговорил(а) ли я сегодня с кем-то близким?",
      joyTitle: "Радость",
      joyQ: "Сделал(а) ли я сегодня что-то для удовольствия?",
    },
  },
  ...
  settings: {
    ...
    dataAutoBackupIos: "iCloud Backup автоматически сохраняет данные раз в сутки — когда iPhone на зарядке, подключён к Wi-Fi и заблокирован (это включено по умолчанию). При смене устройства восстановится всё — кнопки нажимать не надо.",
    dataAutoBackupAndroid: "Android Auto Backup автоматически сохраняет данные в твой Google Drive (это включено по умолчанию). При смене телефона или переустановке всё восстановится — кнопки нажимать не надо.",
    ...
    demoPack_behind_fight: "💥 Что за ссорой",
    demoDataConfirmTitle: "Заменить всё демо-данными?",
    demoDataConfirmDescPack: "Загрузит пакет «{{pack}}» — 8 готовых вопросов + 60 дней инженерных ответов с заранее заложенными неочевидными паттернами. Удалит твои текущие вопросы и записи.",
    demoDataConfirmBtn: "Заменить и сгенерировать",
    demoDataRunning: "Генерируем…",
    demoDataGeneratedTitle: "Демо готово",
    demoDataGeneratedDesc: "{{trackers}} вопросов · {{days}} дней · можно делать скрины",
    demoDataFailedTitle: "Не получилось сгенерировать демо",
    demoUnlockedTitle: "Demo Mode ON",
    demoUnlockedDesc: "Теперь в Settings → Data есть 4 кнопки генерации демо-данных. Тапни на v1.7.5 ещё 7 раз чтобы выключить.",
    demoLockedTitle: "Demo Mode OFF",
    demoLockedDesc: "Кнопки демо-генерации спрятаны. Тапни v1.7.5 7 раз чтобы включить снова.",
    demoModeOn: "DEMO",
  ...
  notifications: {
    ...
    // Тело уведомления когда заголовок несёт конкретный вопрос
    // трекера ("Как ты сегодня спал?"). На экране блокировки мелко —
    // держим коротким и с призывом к действию. "Тапни" а не "свайпни":
    // свайп на уведомлении на экране блокировки — это системный жест
    // отклонить/раскрыть; тап открывает приложение сразу на дневной
    // сессии (App.tsx ловит localNotificationActionPerformed).
    dailyPromptBody: "Тапни чтобы ответить",
  ...
  trackerSettings: {
    ...
    adviceHelp: "Что ты сам(а) себе хочешь сказать сделать, когда увидишь что паттерн повторяется. Это не наш совет — это твоё намерение.",
  ...
  coachmark: {
    ...
    multiBody: "Тапни «Выбрать несколько» и отметь несколько дней разом — удобно если забыл(а) что-то заполнить за прошлые дни.",
    ...
    // Patterns sub-tab walkthrough — fires the FIRST time the user
    // opens the Patterns tab. Companion to overviewTitle/Body in en.ts.
    overviewTitle: "Календарь",
    overviewBody: "Каждый день, когда ты отвечаешь, становится цветным кружком: зелёный — день в норме, красный — проблемный.",
    // Add-Tracker modal walkthrough — fires the FIRST time the user
    // opens the "+" modal. Two короткi step pointing at template and
    // custom modes.
    addTemplatesTitle: "Выбери шаблон",
    addTemplatesBody: "Готовые вопросы по темам: сон, партнёр, настроение, работа, тело и другие. Выбирай и добавляй.",
    addCustomTitle: "Или напиши свой",
    addCustomBody: "Здесь можно написать свой ДА/НЕТ вопрос про что-то именно про тебя. Свои вопросы обычно лучше всего показывают паттерны.",
    // Custom-question Period & Threshold explainer — fires the FIRST
    // time the user enters the Custom tab. Companion to periodTitle/
    // thresholdTitle in en.ts.
    periodTitle: "Период",
    periodBody: "За сколько дней назад MeMap считает статистику по этому вопросу. По умолчанию — 30.",
    thresholdTitle: "Порог",
    thresholdBody: "Сколько проблемных дней в этом периоде надо набрать, чтобы приложение дало сигнал. Меньше = чувствительнее.",
